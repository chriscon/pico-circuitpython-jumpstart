"""
Adapted from https://github.com/plugowski/umenu
(which is unlicensed)
"""
...
class ValueItem(CustomItem, CallbackItem):
    ...
    def __init__(self, name, value_reader, min_v, max_v, step, callback, visible=None, suffix=None):
        super().__init__(name, visible=visible)
...
class Menu:
    ...
    def menu_header(self, text):
        ...
        self.display.text(str.upper(self.current_screen.title), x, 6, 1)
